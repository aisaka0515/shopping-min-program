<template>
    <el-card>
        <el-row :gutter="20" class="header">
            <el-col :span="7">
                <el-input placeholder="请输入商品名称..." clearable vmodel="queryForm.query"></el-input>
            </el-col>
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="hot" label="热卖?" width="100" text-align="center">
                <template v-slot="{ row }">
                    <el-switch v-model="row.hot" @change="hotChangeHandle(row)"></el-switch>
                </template>
            </el-table-column>
            <el-table-column prop="swiper" label="首页幻灯？" width="120" text-align="center">
                <template v-slot="{ row }">
                    <el-switch v-model="row.swiper" @change="swiperChangeHandle(row)"></el-switch>
                </template>
            </el-table-column>
            <el-table-column prop="swiperPic" label="幻灯图片" width="150" text-align="center">
                <template v-slot="scope">
                    <img :src="getServerUrl() + '/image/swiper/' + scope.row.swiperPic" width="150" height="75" />
                </template>
            </el-table-column>
            <el-table-column prop="swiperSort" label="幻灯排序" width="120" text-align="center" />
