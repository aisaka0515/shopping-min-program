<template>
  <el-dialog model-value="productSwiperImageDialogVisible" title="商品轮播图片管理" width="30%" @close="handleClose" center>
    ...
    <el-form ref="formRef" :model="form" label-width="100px" style="text-align: center" :rules="rules">
      ...
      <el-upload :headers="headers" class="avatar-uploader"
        :action="getServerUrl() + '/admin/productSwiperImage/uploadImage'" :show-file-list="false"
