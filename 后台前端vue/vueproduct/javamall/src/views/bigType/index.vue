<template>
    <el-card>
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="name" label="商品大类昵称" width="200" />
    ...
    <imageDialog v-model="imageDialogVisble" :imageDialogValue="imageDialogValue" @initBigTypeList="initBigTypeList"></imageDialog>
</template>
...
import { getServerUrl } from '@/util/axios';
